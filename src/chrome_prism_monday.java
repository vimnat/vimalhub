...
public class chrome_prism_monday {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String assmon = driver
				.findElement(By
						.xpath("//tr[@class='timesheet-row ui-dynamic-row']//input[@placeholder='Type Your project']"))
				.getText();
		if (assmon.isEmpty()) {
			...
			// driver.findElement(By.xpath("//tr[@class='timesheet-row
			// ui-dynamic-row']//input[@placeholder='Type Your Summary']")).sendKeys("#30 :
			// Bench");
			// s.selectByValue("30");
			// Thread.sleep(10000);
