...
public class chrome_aspireprism {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(10000);
		//timesheet page
		driver.findElement(By.xpath("//body[contains(@class,'trac')]/div[contains(@class,'main')]/div[@id='content']/div[contains(@class,'outer-container')]/div[@id='project_container']/table[@id='timesheet_table']/tbody/tr[contains(@class,'timesheet-row existing-row ui-draft')]/td[12]/div[1]")).click();
